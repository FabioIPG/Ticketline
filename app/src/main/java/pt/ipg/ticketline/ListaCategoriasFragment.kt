...
import pt.ipg.ticketline.databinding.FragmentListaCategoriasBinding
...
class ListaCategoriasFragment : Fragment(), LoaderManager.LoaderCallbacks<Cursor> {
    ...
    fun processaOpcaoMenu(item: MenuItem) : Boolean =
        when(item.itemId) {
            R.id.action_inserir -> {
                val acao = ListaCategoriasFragmentDirections.actionListaCategoriasToEditarCategoria()
                findNavController().navigate(acao)
                (activity as MainActivity).atualizaNomeCategoria(R.string.inserir_categoria_label)
                true
            }
            R.id.action_alterar -> {
                val acao = ListaCategoriasFragmentDirections.actionListaCategoriasToEditarCategoria(categoriaSelecionada)
                findNavController().navigate(acao)
                (activity as MainActivity).atualizaNomeCategoria(R.string.alterar_categoria_label)
                true
            }
